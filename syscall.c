...
__attribute__((visibility("default"),externally_visible)) __attribute__((__symver__("numa_sched_setaffinity@libnuma_1.1"))) int numa_sched_setaffinity_v1(pid_t pid, unsigned len, const unsigned long *mask)
{
